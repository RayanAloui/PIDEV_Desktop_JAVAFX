...
public class ModifierCoursControllerD implements Initializable {
    ...
    private TuteurDashboardController mainController;

    public void setMainController(TuteurDashboardController mainController) {
