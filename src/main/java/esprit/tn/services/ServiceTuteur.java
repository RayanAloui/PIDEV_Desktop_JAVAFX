...
import esprit.tn.main.databaseconnection0;
...
public class ServiceTuteur implements ITuteurService {
    ...
    public ServiceTuteur() {
        connection = databaseconnection0.getConnection();
    }
    ...
    public void ajouter(Tuteur t) throws SQLException {
        ...
        try {
            conn = databaseconnection0.getConnection();
    ...
    public List<Integer> getAllTuteurIds() throws SQLException {
        ...
        ResultSet rs = databaseconnection0.getConnection().createStatement().executeQuery(query);
